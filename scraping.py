...
def main():
    ...
    parser.add_argument('--episode', type=str, help="Episode number for dynamic web scraping.")
    ...
    if args.action == 'static':
        if all([args.outfile, args.base_url, args.list_content]):
            static_web(args.outfile, args.base_url, args.list_content,args.total_pages)
        else:
